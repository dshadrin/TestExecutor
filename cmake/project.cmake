...
if(UNIX)
    ...
    #set(BOOST_DEBUG ON)
    set(ENV{BOOST_INCLUDEDIR} /home/dima/local/boost-${PRJ_BOOST_VERSION}/include)
    set(ENV{BOOST_LIBRARYDIR} /home/dima/local/boost-${PRJ_BOOST_VERSION}/lib)
    set(PRJ_QT "Qt6")
    set(ENV{OPENSSL_ROOT_DIR} /home/dima/local)
else()
    set(PRJ_BOOST_VERSION "1.76")
    set(PRJ_QT "Qt6")
endif()
